...
class WMCapitallerPaymentRequest extends WMApiRequest
{
    /** @var int firm_id */
    protected $_firmId;
    ...
    {
        return array(
            WMApiRequestValidator::TYPE_REQUIRED => array('firmId', 'signerWmid', 'transactionNumber', 'senderPurse',
                'recipientPurse', 'amount', 'protectionPeriod', 'askRecipientsPermission'),
        );
    }

    /**
     * SOAP function name for WMSoapApiRequestPerformer
     * @return string
     */
    ...
    {
        return 'WMCapitallerPaymentResponse';
    }
