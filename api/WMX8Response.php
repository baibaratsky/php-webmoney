 ...
 */
class WMX8Response extends WMApiResponse
{
    /** @var int retval */
    ...
    /** @var null|WMX8ResponseWmid testwmpurse/wmid */
    protected $_wmid;

    /** @var null|WMX8ResponsePurse testwmpurse/purse */
    protected $_purse;
    ...
    public function __construct($response)
    {
        ...
        if (!empty($responseObject->testwmpurse->wmid)) {
            $this->_wmid = new WMX8ResponseWmid(
        ...
        if (!empty($responseObject->testwmpurse->purse)) {
            $this->_purse = new WMX8ResponsePurse(
