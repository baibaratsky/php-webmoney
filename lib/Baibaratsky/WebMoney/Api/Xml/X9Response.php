 ...
 */
class X9Response extends ApiResponse
{
    /** @var int reqn */
    ...
    public function __construct($response)
    {
        ...
        foreach ($responseObject->purses as $purse) {
            $this->_purses[] = new X9ResponsePurse($this->_purseToArray($purse));
        }
    }
